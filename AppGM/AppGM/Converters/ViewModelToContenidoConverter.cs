    ...
    public class ViewModelToContenidoConverter : BaseConverter<ViewModelToContenidoConverter>
    {
        public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            switch (value)
            {
                ...
                case ViewModelSeleccionDeControladorBase vm:
                ...
                case ViewModelCreacionEdicionEfecto vm:
                ...
                case ViewModelRealizarTirada vm:
	                return new UserControlRealizarTirada {DataContext = vm};
