...
namespace AppGM.Core
{
    ...
    public static class EnumHelpers
    {
        ...
        public static List<ENumeroParty> PartiesDisponibles => Enum.GetValues(typeof(ENumeroParty)).Cast<ENumeroParty>().ToList();
		...
		public static List<ETipoUnidad> TiposDeUnidadesDisponibles => Enum.GetValues(typeof(ETipoUnidad)).Cast<ETipoUnidad>().ToList();
